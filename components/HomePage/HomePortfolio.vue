  ...
  data() {
    return {
      ...
      videos: [
        ...
        { name: "Work Name", src: "QYHO8w4Y318", id: 6 },
        { name: "Work Name", src: "2HPeNYwFHrM", id: 7 },
        { name: "Work Name", src: "zSWYYIWeLcI", id: 8 },
        { name: "Work Name", src: "GRmNwh5Fd5Y", id: 9 },
        { name: "Work Name", src: "cFbppmmoeHk", id: 10 },
        { name: "Work Name", src: "p0Bepyu9-eU", id: 11 },
        { name: "Work Name", src: "iOVfQP0t5KA", id: 12 },
        { name: "Work Name", src: "658o6WGUbLg", id: 13 },
        { name: "Work Name", src: "WGVFCf9Erhk", id: 14 },
        { name: "Work Name", src: "sFvTRda_MH4", id: 15 },
      ],
    };
  },
